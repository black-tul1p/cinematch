...
import { collection, orderBy, query, addDoc, serverTimestamp, limit } from "firebase/firestore";
...
export default function ChatRoom() {
  ...
  const messagesRef = collection(FireStoreDB, 'chatrooms/fb1ySYptpvDmB6pUNzHb/messages')
